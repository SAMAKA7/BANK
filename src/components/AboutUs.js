        ...
        <Grid container direction='column'>
            ...
            >
                ...
                <Grid item>
                    <Button 
                        style={{color:"black"}}
                        onClick={()=>window.open("https://github.com/SAMAKA7", '_blank')}
                        >
                        <GitHub />
                    </Button>
                    <Button style={{color:"black"}} 
                        onClick={()=>window.open("https://twitter.com/SAK_20027", '_blank')}
                    >
                        <Twitter/>
                    </Button>
                    <Button style={{color:"black"}} 
                        onClick={()=>window.open("https://www.linkedin.com/in/sameer-khan-81748522a/", '_blank')}
                    >
                    <LinkedIn/>
                 </Button>
                </Grid>
